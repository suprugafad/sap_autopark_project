sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("by/iba/ZAP_AUTOPARK_11/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#Autopark_11-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#Autopark_11-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("by.iba.ZAP_AUTOPARK_11.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["by/iba/ZAP_AUTOPARK_11/localService/mockserver"], function (mockserver) {
